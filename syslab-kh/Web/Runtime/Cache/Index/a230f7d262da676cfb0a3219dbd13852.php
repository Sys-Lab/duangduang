...
<form enctype="multipart/form-data" action="<?php echo U('Index/ResManage/handle');?>">  
...
性别:</td> 
 ...
 <input name="sex" type="radio" checked="checked" value="female" />
男
<input name="sex" type="radio" checked="checked" value="male" />
女
</td> 
</tr>  
 <tr bgcolor="#CCCCCC"> 
...
<tr bgcolor="#CCCCCC"> 
<td height="30">爱好</td> 
<td bgcolor="#CCCCCC" height="30"  colspan="3"><textarea name="habbit" cols="60" rows="8" style="width:669px;" class="p1"></textarea></td> 
 </tr>  
</tr>  
 <tr bgcolor="#CCCCCC">  
 <td height="30">工作简历</td>  
 <td  bgcolor="#CCCCCC" height="30" colspan="3"><textarea name="sunmery" cols="60" rows="8" style="width:669px;" class="p1"></textarea></td> 
 </tr>  
 <tr bgcolor="#CCCCCCF">  
 <td height="30">&nbsp;</td>  
 <td  height="30" colspan="3"><input type="submit" name="submit" value="提交" /> 
 <input type="reset" name="submit" value="重置" />
 <a href="<?php echo U('Index/Index/indextwo');?>">返回</a>
 </td> 
