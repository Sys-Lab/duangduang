...
<body>
	...
	<div class="bj">
		...
		<div class="bord">
			...
			<div class="q" style="margin-left:75px"><a href><img id="a" alt="图片e" src="/syslab-kh/Web/Tpl/Index/Public/images/6.png" onmouseover="showf(this)" onmouseout="showe(this)"></img></a></div>
			<div class="q" style="margin-left:75px"><a href><img id="a" alt="图片g" src="/syslab-kh/Web/Tpl/Index/Public/images/8.png" onmouseover="showh(this)" onmouseout="showg(this)"></img></a></div>
		</div>
	</div>
	<script>
