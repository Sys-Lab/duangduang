...
<body>
	<div class="bj">
	<div class="p1">
		<h1 style="position: relative;top: 0px;left:220px;"><?php echo ($data["title"]); ?></h1>
		<p style="position: relative;top: 150px;left:220px;"><?php echo ($data["content"]); ?></p>

<div style="position:absolute;top:300px;left:0px">
<div id="box"> 
<ul id="fill_in"> 

<form  action="<?php echo U('Index/NewsManage/handle');?>" method="POST" > 
<li>姓名：<input id="text" type="text" class="text" name="name1" ></li>
<li>内容：<textarea id="content" style="width:300px; height:100px" name="content1"></textarea> </li>
